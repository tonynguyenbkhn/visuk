...
$grid_css_class = 'col col-md-4 col-12 mb-1';
if ($block_layout === '3-col') {
    $grid_css_class .= ' col-lg-4';
} elseif ($block_layout === '4-col') {
    $grid_css_class .= ' col-lg-3';
}
...
?>
    ...
    <div class="<?php echo esc_attr($_class) ?>" <?php if (!empty($data['id'])) : ?> id="<?php echo esc_attr($data['id']); ?>" <?php endif; ?>>
        <?php if ($data['enable_container']) : ?><div class="<?php echo esc_attr($_class_container); ?>"><?php endif; ?>
            <?php
            get_template_part('templates/title', null, [
            ...
            ?>
            <div class="post-grid--events-wrapper">
                <div class="post-grid--events-container">
                </div>
                <div class="row">
                    <?php
                    ...
                    ?>
                        <div class="<?php echo esc_attr($grid_css_class); ?>">
                            <?php
                            get_template_part(
                                'templates/post-card-event',
                                null,
                                array(
                                    'post_data' => get_post(get_the_ID()),
                                    'post_id' => get_the_ID(),
                                    'view_more_button' => esc_html__('Read more', 'twmp-vis'),
                                    'post_title_limit' => 20,
