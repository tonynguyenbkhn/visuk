...
<div class="<?php echo esc_attr($_class); ?>">
    <a href="<?php echo '/public-individual-page/' . $user->user_login . '/'; ?>">
        <div class="member-grid-item__wrapper">
            ...
            <div class="member-grid-item__content">
                <?php if (!empty($badge) && strtolower($badge['value']) !== 'none'): ?>
                    <div class="member-grid-item__badge text-center">
                        <?php echo twmp_get_svg_icon($badge['value']); ?>
                    </div>
                <?php endif; ?>
                <div class="member-grid-item__content-wrapper">
                    <h3 class="member-grid-item__fullname"><?php echo esc_html($user->display_name); ?></h3>
