...
<article class="<?php echo esc_attr($_class); ?>">
	<div class="post-card__wrapper">
		<?php if ( $data['show_tag'] ): ?>
			<span class="post-card__tag-event">Event</span>
			<?php if ( $button_text === 'Premium access' ): ?>
				<div class="post-card__pre"><?php echo twmp_get_svg_icon('lock'); echo esc_html('Premium access'); ?></div>
			<?php endif; ?>
		<?php endif; ?>
