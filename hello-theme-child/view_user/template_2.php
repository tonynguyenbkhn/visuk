<div class="iump-view-user-wrapp-temp2 member-grid iump-color-scheme-<?php echo esc_attr($data['color_scheme_class']); ?>">
	<?php
	...
	?>
	<div class="ihc-user-page-top-ap-wrapper 234">
			...
			<?php foreach ($data['custom_fields'] as $label => $value): ?>
				<?php if ($value != ''): ?>
					<div class="iump-user-field">
						<div class="iump-label"><?php echo esc_html(stripslashes($label)); ?></div>
						<div class="iump-value"> <?php echo esc_ump_content($value); ?> </div>
						<div class="ihc-clear"></div>
					</div>
	...
	<div class="member-grid-item__content-wrapper">
		<?php if (!empty($position)): ?>
			<span class="member-grid-item__position text-center w-100 d-block"><?php echo esc_html($position); ?></span>
		<?php endif; ?>
		<?php if (!empty($university)): ?>
			<span class="member-grid-item__university text-center w-100 d-block"><?php echo esc_html($university); ?></span>
		<?php endif; ?>
		<?php if (!empty($socials)): ?>
			<ul class="member-grid-item__socials">
				<?php
