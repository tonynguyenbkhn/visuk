  ...
  <?php if ($data['isRegistered']) { ?>
    ...
    <div class="info-section">
      ...
      <div class="info-section__main">
        <span class="label">Billed Today</span>
        <span class="price"><?php echo ihc_format_price_and_currency($data['currency'], $data['preparePaymentData']['dynamic_price']); ?></span>
      </div>
    </div>
    <div class="ihc-checkout-page-left-side ihc-checkout-page-one-column">
      ...
      ?>
        ...
        <div id="ihc-checout-page-purchase-payment-method-section">
          <?php include get_theme_file_path() . '/ump/checkout/checkout-payment-method.php'; ?>
        </div>
      <?php } ?>
    ...
    <div class="ihc-checkout-page-right-side ihc-checkout-page-one-column">
      ...
      <div id="ihc-checout-page-purchase-subscription-details-section">
        <?php include get_theme_file_path() . '/ump/checkout/checkout-subscription-details.php'; ?>
      </div>
